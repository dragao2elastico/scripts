...
function onCreatePost()
		makeLuaText('on', 'You Control Opponent', 0, 250, 225)
		setTextSize('on', 50)
		setTextFont('on', "DK Black Bamboo.ttf");
		setProperty('on.x', 400)
		makeLuaText('off', 'You Control Bf', 0, 250, 225)
		setTextFont('off', "DK Black Bamboo.ttf");
		setTextSize('off', 50)
...
if activated then
		...
		if songSplashSkin == nil or songSplashSkin == 'noteSplashTexture' then 
			...
			setTextFont('scoreTxtP2', "DK Black Bamboo.ttf");
			setObjectCamera('scoreTxtP2', 'hud')
			setProperty('scoreTxtP2.borderSize', 1.25)
			setTextSize('scoreTxtP2', 20)
			setTextAlignment('scoreTxtP2.x', 'center')
			setTextAlignment('scoreTxtP2.y', 1600)
...
function onUpdate(elapsed) 
	...
	if activated then
		...
		if not (cpuControlled) and not (getProperty('inCutscene')) then
			...
			if getProperty('health') > 2.5 then
...
function ratingComboStuff(rating, diff, ratingImg)
	...
	setTextFont('coolText', "DK Black Bamboo.ttf");
